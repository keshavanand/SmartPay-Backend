...
import com.keshav.smartpay.domain.dtos.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> baseExceptionHandler(BaseException ex, HttpServletRequest request){
    ...
    public ResponseEntity<ErrorResponse> httpMessageNotReadableExceptionHandler(HttpMessageNotReadableException ex, HttpServletRequest request){
